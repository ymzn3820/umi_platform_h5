<template>
	<view style="background-color: #FEFEFE;">
		...
		<slider v-if="active==1" class="slider" v-model="blur" :min="min" :max="max" @change="handleSliderChange"
			block-color='#1F64FF' activeColor='#1F64FF' block-size='16'></slider> -->
		<view class="bottom">
